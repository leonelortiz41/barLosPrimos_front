...
$('#MegaComun').click((e)=>{selectComida("comun","Mega comun",hamburguesasdb[2].precio,e.target.classList[1])
...
$('#MegaPapas').click((e)=>{selectComida("papas","Mega esp. de papas",hamburguesasdb[4].precio,e.target.classList[1])
}).css("background", colorHamPapas)
...
$('#PizzaComun').click((e)=>{selectComida(0,pizzasdb[0].nombre,pizzasdb[0].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzaJamon').click((e)=>{selectComida(0,pizzasdb[1].nombre,pizzasdb[1].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzaFugazza').click((e)=>{selectComida(0,pizzasdb[2].nombre,pizzasdb[2].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzaCalabresa').click((e)=>{selectComida(0,pizzasdb[3].nombre,pizzasdb[3].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzaNapolitana').click((e)=>{selectComida(0,pizzasdb[4].nombre,pizzasdb[4].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzaSardina').click((e)=>{selectComida(0,pizzasdb[5].nombre,pizzasdb[5].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzanesaP4').click((e)=>{selectComida(0,pizzasdb[6].nombre,pizzasdb[6].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#PizzanesaP2').click((e)=>{selectComida(0,pizzasdb[7].nombre,pizzasdb[7].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaComun').click((e)=>{selectComida(0,pizzasdb[8].nombre,pizzasdb[8].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaJamon').click((e)=>{selectComida(0,pizzasdb[9].nombre,pizzasdb[9].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaFugazza').click((e)=>{selectComida(0,pizzasdb[10].nombre,pizzasdb[10].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaCalabresa').click((e)=>{selectComida(0,pizzasdb[11].nombre,pizzasdb[11].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaNapolitana').click((e)=>{selectComida(0,pizzasdb[12].nombre,pizzasdb[12].precio,e.target.classList[1])
}).css("background", colorPizzas)

$('#mediaPizzaSardina').click((e)=>{selectComida(0,pizzasdb[13].nombre,pizzasdb[13].precio,e.target.classList[1])
}).css("background", colorPizzas)


$('#PapasComun').click((e)=>{selectComida(0,papasdb[0].nombre,papasdb[0].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#PapasGratinadas').click((e)=>{selectComida(0,papasdb[1].nombre,papasdb[1].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#Salchipapas').click((e)=>{selectComida(0,papasdb[2].nombre,papasdb[2].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#LomitoPlato').click((e)=>{selectComida(0,platosdb[0].nombre,platosdb[0].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MilanesaNapolitana').click((e)=>{selectComida(0,platosdb[1].nombre,platosdb[1].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MilanesaCaballo').click((e)=>{selectComida(0,platosdb[2].nombre,platosdb[2].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MexicanoP1').click((e)=>{selectComida(0,platosdb[3].nombre,platosdb[3].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MexicanoP2').click((e)=>{selectComida(0,platosdb[4].nombre,platosdb[4].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MilanesaNapolitanaEnsa').click((e)=>{selectComida(0,platosdb[5].nombre,platosdb[1].precio,e.target.classList[1])
}).css("background", colorPapas)

$('#MilanesaEnsa').click((e)=>{selectComida(0,platosdb[6].nombre,platosdb[2].precio,e.target.classList[1])
}).css("background", colorPapas)
