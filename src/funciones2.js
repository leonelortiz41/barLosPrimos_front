...
//  const impCuaderno = async(r, suma, table2, date, viajes1, viajes2, viajes3, comision) => {
// 	let w = window.open()
// 	let div = w.document.createElement("div");
// 	w.document.body.appendChild(div);
// 	div.classList.add("cuadernoPDF")
// 	div.innerHTML = `<h2>DIA: ${date}</h2><br>
// 					<h2>VIAJES:</h2>
...
// 	// w.focus();
// 	let pdf= new jsPDF()
// 	// await pdf.html(w.document.body, {"width":130})
// 	await pdf.html(w.document.body, {
